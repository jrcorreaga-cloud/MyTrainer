...
#include "../../../../src/presentation/views/LoginView.h"
...
void LoginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginView::*)(const User & )>(_a, &LoginView::loginSuccessful, 0))
            return;
    }
}
...
// SIGNAL 0
void LoginView::loginSuccessful(const User & _t1)
{
